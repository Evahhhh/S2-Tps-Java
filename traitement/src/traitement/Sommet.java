...
/**
 * Cette classe represente une observation sous forme de sommet
 * @author Tristan
 * @version 1.3
 */
public class Sommet {
     ...
     * @param coord -  coordonnees du sommet
     * @param date - date du  sommet
     * @param espece - espece du sommet
     */
    ...
    /**
     * constructeur de sommet, recupere tous les attributs via les getter d observation
     * @param obs - observation dont on recupere tous les attributs
     */
     ...
     * @return distance calculee entre deux sommets
     */
    ...
    /**
     * getter de coordLieu
     * @return coordonnees du lieu du sommet
     */
