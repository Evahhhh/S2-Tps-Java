 ...
 * @author Tristan, William, Theo, Eve-Anne
 * @version 1.0
 */
public class ScenarioTraitement {
    public static void main(String[] args){
        //nous sert pour une meilleure presentation dans la console
        String separator = "---------------------------------------------------------------------------";
     ...
     * @return sommets - un ArrayList de sommets
     */
    ...
    /**
     * creer une HashMap contenant chaque sommet avec leurs voisins respectifs
     * @param sommets - un ArrayList de sommets
     * @return mapGraph - une HashMap de sommets et de voisins
     */
    ...
    /**
     * teste le constructeur de la classe Sommet
     */
    ...
    /**
     * teste la methode CalculeDist() de la classe Sommet
    ...
    /**
     * teste de la methode estDansGraphe
     * @param g - graphe
     */
    ...
    /**
     * teste de la methode calculeDegre()
     * @param g - graphe
     */
    ...
    /**
     * teste de la methode calculeDegres()
     * @param g - graphe
     */
    ...
    /**
     * teste de la methode sontVoisins()
     * @param g - graphe
     */
    ...
    /**
     * teste de la methode existeChemin()
     * @param g - graphe
     */
     ...
     * note : cette methode fonctionne si la methode testAjouteArete() a ete executee juste avant
     * c'est pour eviter d'avoir des problemes avec les autres
     ...
     * @return mapGraph - un HashMap contenant chaque sommet avec la liste de ses voisins
     */
