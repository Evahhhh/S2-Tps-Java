...
public class NidGCI implements IObs<ObsGCI> {
	...
	/** nombre d'envols reussis pour ce nid */
	private int nbEnvol;
	...
	/** 
	 * Getter des differentes observations
