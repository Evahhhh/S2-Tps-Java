...
public class ObsGCI extends Observation {
	 ...
	 * @param observateurs - ArrayList contenant le/les nom(s) des observateurs
	...
	/**
	 * setter pour le parametre nombre soit le contenu du nid
	 ...
	 * @param natureObs - nouvelle valeur 
	 */
	...
	/** 
	 * precise l'espece observee dans cette classe 
